@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        <div class="flex justify-between flex-1 sm:hidden mt-12">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between md:flex-col my-4">
            <div>
                <p class="text-sm text-gray-700 leading-5 my-4 hidden">
                    {!! __('Showing') !!}
